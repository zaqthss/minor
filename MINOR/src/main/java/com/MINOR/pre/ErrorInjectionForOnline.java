...
public class ErrorInjectionForOnline {
    ...
    @Deprecated
    public ErrorInjectionForOnline(double _mu, double _sigma, double _lRate, int _eLength, int _eSections) {
        mu = _mu;
        sigma = _sigma;
        lRate = _lRate;
        eLength = _eLength;
     ...
     */
    public ErrorInjectionForOnline(List<List<Double>> _data, List<Integer> _timestamps, double[] _mean, double[][] _covMatrix, double[][] _corMatrix,
