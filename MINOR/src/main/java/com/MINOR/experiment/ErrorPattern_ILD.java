...
/**
 * Varying error pattern on ILD
 * since experiment on ILD with SHIFT error has been conducted by ErrorRate_ILD
 * so, this will only run experiment on ILD with INNOVATIONAL error
 */
public class ErrorPattern_ILD {
    public static void main(String[] args) {
        // experiment setting
        int dim = 2;
        String variableName = "er";
        DataSetType dt = DataSetType.ILD;
        ErrorInjectorType et = ErrorInjectorType.INNOVATIONAL;
        int p0 = Constants.p0;
        ...
        String basePath = Constants.resultPathPrefix + dt + "/summary/pattern/";
